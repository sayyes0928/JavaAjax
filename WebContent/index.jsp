...
<script src="http://code.jquary.com/jquary-3.1.1.min.js"></script>
<script src="js/bootstrap.js"></script>

</head>
<body>
	<div class="container">
		<form method="post" action="./userResister">
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text"
							id="userID" name="userID" maxLength="20"></td>
					...
					<tr>
						...
						<td colspan="2">
							<div class="form-group"style="text-align: center; margin: 0 outo;">
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email"
							id="userEamil" name="userEamil" maxLength="20"></td>
					</tr>
					<tr>
